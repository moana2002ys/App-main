...
- [jogak BA cycle invariants](jogak-ba-rules.md) — never expose risk labels/levels; gates only clear via self-report recheck; plan-first difficulty; local slot engine.
